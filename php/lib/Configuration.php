...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://www.vereinsflieger.de/interface/rest';
    ...
    {
        $report  = 'PHP SDK (Diginize\VereinsfliegerApi) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 466.98009' . PHP_EOL;
