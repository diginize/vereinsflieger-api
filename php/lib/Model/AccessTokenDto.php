...
/**
 * AccessTokenDto Class Doc Comment
 *
 * @category Class
 * @package  Diginize\VereinsfliegerApi
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 */
class AccessTokenDto implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AccessTokenDto';
     ...
     * Sets url
     *
     * @param string|null $url The IP address of the server requested the access token
     *
     * @return $this
     */
